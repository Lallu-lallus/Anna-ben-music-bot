...
"""
pic = "https://telegra.ph/file/07af4bdb370593909aa51.jpg"
...
async def start(client, message):
    ...
    await message.reply_photo(photo=random.choice(PIC)(HOME_TEXT.format(message.from_user.first_namemessage.from_user.id), reply_markup=reply_markup)
